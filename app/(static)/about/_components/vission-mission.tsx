          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            ...
            <div className="text-center sm:text-right">
              ...
              <p className="font-normal text-sm md:text-base leading-7">
                أن نكون الخيار الأول عالميًا في التدريب والتطوير المهني، ونقدم حلول تعليمية مبتكرة ذات تأثير مستدام.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            ...
            <div className="text-center sm:text-right">
              ...
              <p className="font-normal text-sm md:text-base">
                تمكين الأفراد والفرق والمؤسسات لتحسين الأداء من خلال برامج تدريبية متخصصة تجمع بين النظرية والتطبيق العملي، مصممة خصيصًا لاحتياجات المؤسسات.
              </p>
            </div>
          </div>
        </div>
