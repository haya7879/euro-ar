  ...
  return (
    <>
      ...
      <HeroBanner
        ...
        description="تأسست يوركويست إنترناشيونال عام 2015 على يد فريق يمتلك خبرة تفوق 25 عامًا في التدريب والتطوير المهني. خلال مسيرتنا، قدمنا أكثر من 1000 برنامج تدريبي شارك فيها ما يزيد عن 15,000 متدرب في مختلف القطاعات وعواصم عالمية مثل دبي، لندن، برشلونة، إسطنبول، فيينا، باريس، وجنيف."
