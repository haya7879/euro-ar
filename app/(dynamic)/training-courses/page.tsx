    ...
    return (
      <>
        <Schema
          ...
          pageDescription="استكشف جميع تخصصات التدريب في الدول التدريبية العالمية. ابحث عن دورات تدريبية مهنية في الإدارة, الموارد البشرية, التكنولوجيا, المالية, وغيرها على مختلف المجالات."
