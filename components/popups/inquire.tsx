            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="grid gap-x-2 gap-y-4 md:grid-cols-3 max-md:grid-cols-1">
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="inquire_full_name" className="text-xs text-[#333]">الاسم الكامل</label>
                  <input
                    type="text"
                ...
                {/* Email */}
                <div className="flex flex-col gap-1">
                  <label htmlFor="inquire_email" className="text-xs text-[#333]">البريد الإلكتروني</label>
                  <input
                    type="email"
                    id="inquire_email"
                    name="email"
                ...
                {/* Company */}
                <div className="flex flex-col gap-1">
                  <label htmlFor="inquire_company" className="text-xs text-[#333]">الشركة</label>
                  <input
                    type="text"
                    id="inquire_company"
                    name="company"
                ...
                {/* City */}
                <div className="flex flex-col gap-1">
                  <label htmlFor="inquire_city" className="text-xs text-[#333]">المدينة</label>
                  <input
                    type="text"
                    id="inquire_city"
                    name="city"
                ...
                {/* Country */}
                <div className="flex flex-col gap-1">
                  <label htmlFor="inquire_country" className="text-xs text-[#333]">الدولة</label>
                  <input
                    type="text"
                    id="inquire_country"
                    name="country"
              ...
              <div className="message-group flex flex-col gap-1">
                <label htmlFor="inquire_message" className="text-xs text-[#333]">الرسالة</label>
                <textarea
                  id="inquire_message"
                  name="message"
                  placeholder="رسالتك"
